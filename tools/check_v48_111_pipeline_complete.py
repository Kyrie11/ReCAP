...
def main() -> int:
    ...
    for k in ("runtime", "balanced", "precision", "balanced_state", "precision_state", "comparison", "v48_110_pipeline", "v48_110_comparison"):
    ...
    for v in ("balanced", "precision"):
        d = docs[v]
        if not (d.get("valid") and d.get("engineering_version") == "v48.111.0-OC-CNGO" and d.get("variant") == v and d.get("audit_only") and d.get("convex_closed_form_ridge")): errors.append(v)
    ...
    out = {
        "schema": "ocrap-v48.111-cngo-pipeline-complete-v1", "engineering_version": "v48.111.0-OC-CNGO",
        "valid": not errors, "attribution_ready": not errors, "errors": errors,
        "experiment_type": "audit_only_constraint_native_candidate_agent_geometry_orientation", "artifacts": artifacts,
        ...
        "v48_110_pipeline_sha256": sha(a.v48_110_pipeline), "v48_110_comparison_sha256": sha(a.v48_110_comparison),
        "authoritative_v48_110_comparison_sha256": AUTHORITATIVE_V110_COMPARISON_SHA256,
    }
