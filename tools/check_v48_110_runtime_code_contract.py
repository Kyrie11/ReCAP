...
from ocrap.v48_110_candidate_agent_topology_orientation import ENGINEERING_VERSION,contract_checks
ACTIVE=[
"scripts/run_v48_110_dcp_drfc_bcde_rifa_cato_two_gpu.sh",
"src/ocrap/v48_110_candidate_agent_topology_orientation.py",
"tools/run_v48_110_candidate_agent_topology_orientation_audit.py",
"tools/compare_v48_110_cato.py",
"tools/check_v48_110_runtime_code_contract.py",
"tools/check_v48_110_pipeline_complete.py",
]
...
def main():
 ...
 out={
   "schema":"ocrap-v48.110-cato-runtime-code-contract-v1","engineering_version":ENGINEERING_VERSION,"valid":not errors,"attribution_ready":not errors,"errors":errors,"runtime_files":files,
   "scientific_contract":{
     "audit_only":True,"candidate_agent_active_constraint_topology":True,"score_family":"linear_on_fixed_candidate_agent_topology_features",
     "raw_candidate_dim":156,"agent_dim":10,"nearest_dim":1716,"topology_dim":3588,
     ...
     "topology_features":"u_plus_active1_active2_agent_cross_plus_clearance_gap_cross",
     "candidate_agent_products_after_active_selection":True,"agent_topology_permutation_invariant":True,"agent_set_candidate_invariant":True,
     ...
     "same_convex_solver_for_base_nearest_topology":True,"within_group_action_permutation_control":True,
